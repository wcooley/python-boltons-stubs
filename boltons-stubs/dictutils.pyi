...
class OneToOne:
    ...
    def __setitem__(self, key: Union[str, int], val: Optional[Union[int, str]]) -> None: ...
    def clear(self) -> None: ...
...
class OrderedMultiDict:
    ...
    def __getitem__(self, k: Union[str, int]) -> Optional[Union[int, str, OrderedMultiDict]]: ...
    ...
    def _insert(self, k: Union[str, int], v: Optional[Union[int, OrderedMultiDict, str]]) -> None: ...
    def _remove(self, k: str) -> None: ...
    def _remove_all(self, k: str) -> None: ...
    def add(self, k: Union[str, int], v: Optional[Union[str, int, OrderedMultiDict]]) -> None: ...
    def clear(self) -> None: ...
    ...
    def items(self, multi: bool = ...) -> Union[List[Tuple[str, int]], List[Tuple[str, str]], List[Tuple[int, str]]]: ...
    def iteritems(
        self,
        multi: bool = ...
    ) -> Iterator[Union[
    ...
    def popall(self, k: str, default: Any = ...) -> Optional[Union[List[int], List[str]]]: ...
    def poplast(
        self,
        k: Any = ...,
        default: Any = ...
